...
//
//    @Test
//    public final void testWaterVehicle(){
//        Boat boat = new Boat("Alice", 10);
//        assert(boat.getVehicleName() == "Alice");
